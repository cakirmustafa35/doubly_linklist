...
//baştaki node'u silmeyi öğrendik
//şimdi get node ile node çağırmayı öğrenicez 
#include <iostream>
using namespace std;
...
public:
    ...
    void deleteFirstNode() {//ilk node silme
        if (count == 0)
            return;
   ...
   /* Node* getNode(int index) {// daha iyisi yazılabilcek bir kod 
...
int main()
{
    ...
    cout << ""<< doublyLinkedList1->getNode(3)->deger;
